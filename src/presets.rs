//! Ambisonic decoder configuration presets
//!
...
pub const SQUARE: &'static str = include_str!(concat!(env!("OUT_DIR"), "/share/openal/presets/square.ambdec"));
...
pub const RECTANGLE: &'static str = include_str!(concat!(env!("OUT_DIR"), "/share/openal/presets/rectangle.ambdec"));
...
pub const ITU51: &'static str = include_str!(concat!(env!("OUT_DIR"), "/share/openal/presets/itu5.1.ambdec"));
...
pub const HEXAGON: &'static str = include_str!(concat!(env!("OUT_DIR"), "/share/openal/presets/hexagon.ambdec"));
...
pub const S3D71: &'static str = include_str!(concat!(env!("OUT_DIR"), "/share/openal/presets/3D7.1.ambdec"));