...
/// 44100 Hz HRTF default data set
pub const HRTF_44100: &'static [u8] = include_bytes!(concat!(env!("OUT_DIR"), "/share/openal/hrtf/default-44100.mhr"));

/// 48000 Hz HRTF default data set
pub const HRTF_48000: &'static [u8] = include_bytes!(concat!(env!("OUT_DIR"), "/share/openal/hrtf/default-48000.mhr"));